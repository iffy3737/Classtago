...
const seeds: Record<string, LocaleSeed> = {
  en: {
    ...
    register:'Register Your Institution', demo:'Start Live Demo', studentFree:'Schools subscribe. Students access every enabled student module free—from confirmed admission until leaving.',
    whyChoose:'Why schools choose Classtago', advantagesTitle:'Not another collection of forms. A connected school operating system.',
    ...
    finderText:'Enter the school name or official Classtago school code.', ctaText:'Every institution is verified before its secure workspace is created.',
  ...
  hi: {
    ...
    register:'अपनी संस्था पंजीकृत करें', demo:'लाइव डेमो शुरू करें', studentFree:'सदस्यता स्कूल लेता है। प्रवेश से लीविंग तक विद्यार्थियों के सभी सक्रिय मॉड्यूल निःशुल्क रहते हैं।',
    whyChoose:'स्कूल Classtago क्यों चुनते हैं', advantagesTitle:'केवल फॉर्मों का संग्रह नहीं—एक जुड़ा हुआ स्कूल संचालन तंत्र।',
    ...
    benefitText:'वास्तविक स्कूल कार्यों के लिए तेज़, बहुभाषी और सुरक्षित रूप से जुड़े समाधान।', finderText:'स्कूल का नाम या आधिकारिक Classtago स्कूल कोड दर्ज करें।', ctaText:'सुरक्षित कार्यक्षेत्र बनाने से पहले हर संस्था का सत्यापन किया जाता है।',
  ...
  ur: {
    ...
    register:'اپنا ادارہ رجسٹر کریں', demo:'لائیو ڈیمو شروع کریں', studentFree:'سبسکرپشن اسکول لیتا ہے۔ داخلہ سے لیونگ تک طلبہ کے تمام فعال ماڈیول مفت رہتے ہیں۔',
    whyChoose:'اسکول Classtago کیوں منتخب کرتے ہیں', advantagesTitle:'صرف فارموں کا مجموعہ نہیں—ایک مربوط اسکول آپریٹنگ سسٹم۔',
    ...
    benefitText:'حقیقی اسکولی کام کے لیے تیز، کثیر لسانی اور محفوظ طور پر مربوط نظام۔', finderText:'اسکول کا نام یا سرکاری Classtago اسکول کوڈ درج کریں۔', ctaText:'محفوظ ورک اسپیس بنانے سے پہلے ہر ادارے کی تصدیق کی جاتی ہے۔',
  ...
  bn: {
    ...
    whyChoose:'স্কুল কেন Classtago বেছে নেয়', advantagesTitle:'শুধু ফর্মের সংগ্রহ নয়—একটি সংযুক্ত স্কুল পরিচালন ব্যবস্থা।',
    ...
    benefitText:'বাস্তব স্কুল কাজের জন্য দ্রুত, বহুভাষিক ও নিরাপদ সংযুক্ত ব্যবস্থা।', finderText:'স্কুলের নাম বা অফিসিয়াল Classtago কোড লিখুন।', ctaText:'নিরাপদ কর্মক্ষেত্র তৈরির আগে প্রতিটি প্রতিষ্ঠান যাচাই করা হয়।',
  ...
  mr: {
    ...
    register:'आपली संस्था नोंदवा', demo:'थेट डेमो सुरू करा', studentFree:'सदस्यता शाळा घेते. प्रवेशापासून लीव्हिंगपर्यंत विद्यार्थ्यांचे सर्व सक्रिय मॉड्यूल मोफत राहतात।',
    whyChoose:'शाळा Classtago का निवडतात', advantagesTitle:'फॉर्मचा संच नव्हे—एक जोडलेली शाळा संचालन प्रणाली।', promiseTitle:'संपूर्ण शालेय प्रवासात प्रत्येक सक्रिय विद्यार्थ्यासाठी मोफत।', identityTitle:'आपले शाळा संकेतस्थळ आणि ERP प्रवेश—एकत्र, पण पूर्णपणे आपल्या ओळखीत।',
    finderTitle:'आपले शाळा पोर्टल शोधा', ctaTitle:'विखुरलेले शालेय काम एका जोडलेल्या प्लॅटफॉर्मवर आणण्यासाठी तयार आहात?', benefitText:'खऱ्या शालेय कामांसाठी जलद, बहुभाषिक आणि सुरक्षित जोडलेले उपाय।', finderText:'शाळेचे नाव किंवा अधिकृत Classtago कोड लिहा।', ctaText:'सुरक्षित कार्यक्षेत्र तयार करण्यापूर्वी प्रत्येक संस्थेची पडताळणी होते।',
