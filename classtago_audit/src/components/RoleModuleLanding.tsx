...
import { ArrowLeft, ArrowRight, ChevronRight, Link2, ShieldCheck, Sparkles } from 'lucide-react';
...
export default function RoleModuleLanding({ module, categoryLabel, role, onBack, onOpenFeature }: RoleModuleLandingProps) {
  return (
