# EDUNIXO R2.5.50 Technology Test Checklist
...
7. Queue one offline Attendance/Mark Draft in Android. Reconnect network and leave the app closed/backgrounded. Sync Guardian may remind after the WorkManager delay; opening EDUNIXO should let the existing authenticated sync engine perform the actual upload.
