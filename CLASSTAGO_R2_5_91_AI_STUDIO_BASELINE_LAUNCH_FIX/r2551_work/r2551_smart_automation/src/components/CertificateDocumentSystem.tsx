                    ...
                    <div className="official-lc-sheet text-[#4b3d43] space-y-2" style={{ fontFamily: 'Georgia, Times New Roman, serif' }}>
                      ...
                      <div className="grid grid-cols-[1fr_1fr_1fr_92px] gap-5 items-end pt-4 text-[11px]">
                        ...
                        <div className="flex justify-center text-[#55409a]">
                          <SchoolSealMark schoolName={schoolName} location={academicSetup?.schoolProfile?.district ? `${academicSetup?.schoolProfile?.villageCity || 'Taloda'}, ${academicSetup.schoolProfile.district}` : 'Taloda, Dist. Nandurbar'} className="h-[82px] w-[82px] opacity-80" />
                        </div>
                      </div>
