...
export default function SchoolCommandCenter({ user, activeFeatureId, onOpenModule }: Props) {
  ...
  return <div className="mx-auto w-full max-w-[1500px] space-y-6">
    <header className="edx-dark-contrast-surface overflow-hidden rounded-[1.75rem] border border-white/10 bg-[radial-gradient(circle_at_8%_0%,rgba(34,211,238,.2),transparent_32%),radial-gradient(circle_at_92%_0%,rgba(139,92,246,.2),transparent_35%),linear-gradient(135deg,#07172d,#080b1b_55%,#17112e)] p-6 text-white shadow-2xl sm:p-8">
    ...
    <section id="command-links" className="scroll-mt-24">
      ...
      <div className="edx-balanced-grid mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        <Quick label="Admissions Review & Confirmation" onClick={() => onOpenModule('hm-admission-campaigns')} />
