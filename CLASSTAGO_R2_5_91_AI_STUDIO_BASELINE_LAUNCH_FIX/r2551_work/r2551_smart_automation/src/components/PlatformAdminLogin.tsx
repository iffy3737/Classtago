  ...
  const submit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (result.user.role !== 'super_admin') {
        ...
        setError('This entrance is reserved for EDUNIXO Platform Administrators. Please open your school website for school ERP login.');
        return;
      }
    ...
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl sm:p-8">
      <div className="mb-6 flex items-start gap-4">
        ...
        <div>
          ...
          <h2 className="mt-1 text-2xl font-black tracking-tight text-slate-950">EDUNIXO Administrator</h2>
