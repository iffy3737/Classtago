...
start('preview', [viteCli, '--host', '0.0.0.0', '--port', '3000'], {
  NODE_ENV: 'development',
  // AI Studio is the browser/web preview. Keep the public website as the
  // default surface; the ERP app runtime is entered explicitly through
  // /app, app./erp. hosts, or the native Android build.
