...
// Initial Core Accounts Seed
const CORE_COA_ACCOUNTS: ChartOfAccount[] = [
  { id: 'acc_cash', name: 'Cash in Hand (Main)', group: 'Cash', description: 'Primary physical cash safe of the school', isSystem: true, openingBalance: 45000 },
  { id: 'acc_bank_sbi', name: 'State Bank of India (A/C: 104882)', group: 'Bank', description: 'Primary treasury account SBI Taloda', isSystem: true, openingBalance: 250000 },
  { id: 'acc_bank_hdfc', name: 'HDFC Bank (Scholarship A/C)', group: 'Bank', description: 'Scholarship and Special Grants HDFC A/C', isSystem: true, openingBalance: 120000 },
  { id: 'acc_inc_tuition', name: 'Tuition Fee Income', group: 'Income', description: 'Annual Tuition Fees collected from students', isSystem: true, openingBalance: 0 },
  { id: 'acc_inc_admission', name: 'Admission Fee Income', group: 'Income', description: 'New Intake registration charges', isSystem: true, openingBalance: 0 },
  { id: 'acc_inc_cert', name: 'Certificate & Documents Fee', group: 'Income', description: 'Bonafide, Leaving, and Duplicate certificates fees', isSystem: true, openingBalance: 0 },
  { id: 'acc_inc_grant', name: 'Government Aid & Grants', group: 'Income', description: 'State welfare and infrastructure assistance grants', isSystem: true, openingBalance: 0 },
  { id: 'acc_inc_donations', name: 'Charity & Donations', group: 'Income', description: 'Public trust and alumni contributions', isSystem: true, openingBalance: 0 },
  { id: 'acc_inc_interest', name: 'Bank Interest Earned', group: 'Income', description: 'Interest accumulated in bank reserves', isSystem: true, openingBalance: 0 },
  { id: 'acc_exp_electricity', name: 'Electricity Utility Expense', group: 'Expenses', description: 'MSEDCL school campus electricity supply bills', isSystem: true, openingBalance: 0 },
  { id: 'acc_exp_water', name: 'Water & Sanitation Bill', group: 'Expenses', description: 'Municipal water supply and maintenance bills', isSystem: true, openingBalance: 0 },
  { id: 'acc_exp_comm', name: 'Telephone & Internet Charges', group: 'Expenses', description: 'Broadband, office phone, and digital services', isSystem: true, openingBalance: 0 },
  { id: 'acc_exp_stationery', name: 'Stationery & Printing Expense', group: 'Expenses', description: 'Ledgers, chalk, exam sheet printouts, registers', isSystem: true, openingBalance: 0 },
  { id: 'acc_exp_maintenance', name: 'Repairs & Campus Maintenance', group: 'Expenses', description: 'Building whitewash, playground leveling, plumbing', isSystem: true, openingBalance: 0 },
  { id: 'acc_exp_lab', name: 'Science Laboratory Supplies', group: 'Expenses', description: 'Chemicals, physics apparatus, glass flasks', isSystem: true, openingBalance: 0 },
  { id: 'acc_exp_library', name: 'Library Resource Acquisitions', group: 'Expenses', description: 'Reference guides, Urdu text books, encyclopedias', isSystem: true, openingBalance: 0 },
  { id: 'acc_exp_sports', name: 'Sports & Athletic Goods', group: 'Expenses', description: 'Cricket bats, footballs, volleyball nets, medals', isSystem: true, openingBalance: 0 },
  { id: 'acc_exp_cultural', name: 'Cultural Day Events Expense', group: 'Expenses', description: 'Annual day stage setup, prizes, microphones hire', isSystem: true, openingBalance: 0 },
  { id: 'acc_liab_schol', name: 'Scholarship Disbursal Liability', group: 'Liabilities', description: 'Awaiting student disbursement grants', isSystem: true, openingBalance: 15000 },
];

const DEFAULT_FINANCIAL_YEARS: FinancialYear[] = [
  { id: 'fy_25_26', name: '2025-26', openingBalance: 25000, isLocked: true, isClosed: true, closedAt: '2026-03-31', closedBy: 'System' },
  { id: 'fy_26_27', name: '2026-27', openingBalance: 45000, isLocked: false, isClosed: false },
  { id: 'fy_27_28', name: '2027-28', openingBalance: 0, isLocked: false, isClosed: false }
];
...
export default function SmartAccountingManager({ lang, user, onRefreshData, activeFeatureId }: SmartAccountingManagerProps) {
  ...
  const [selectedLedgerId, setSelectedLedgerId] = useState<string>('acc_cash');
  ...
  const [vDebitAccount, setVDebitAccount] = useState('acc_cash');
  const [vCreditAccount, setVCreditAccount] = useState('acc_inc_tuition');
  ...
  const handleCloseFinancialYear = async (fyId: string) => {
    ...
    const updatedFYs = financialYears.map(f => {
      ...
      if (f.name === '2027-28' && targetFY.name === '2026-27') {
        return { ...f, openingBalance: cashBalance };
      }
      return f;
    });
