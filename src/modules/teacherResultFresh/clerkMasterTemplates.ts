...
export const clerkDefaultMasterTemplates = [
  {
    ...
    sections: [
      ...
      { text: 'Academic Year: configured at runtime | Assessment Type: Continuous & Comprehensive Evaluation (CCE)', className: 'font-mono text-center text-slate-500 text-[10px] py-1 bg-white border-b border-slate-200' }
    ],
    headers: [
  ...
  },
  {
    ...
    sections: [
      ...
      { text: 'Academic Year: configured at runtime | Language Core Assessment Framework', className: 'font-mono text-center text-slate-500 text-[10px] py-1 bg-white border-b border-slate-200' }
    ],
    headers: [
  ...
  },
  {
    ...
    sections: [
      ...
      { text: 'Academic Year: configured at runtime | Board Examination Pattern', className: 'font-mono text-center text-slate-500 text-[10px] py-1 bg-white border-b border-slate-200' }
    ],
    headers: [
  ...
  },
  {
    ...
    sections: [
      ...
      { text: 'Academic Year: configured at runtime | Subject: Hindi / Marathi Composite | Board Examination Pattern', className: 'font-mono text-center text-slate-500 text-[10px] py-1 bg-white border-b border-slate-200' }
    ],
    headers: [
      { id: 'h1', text: 'Sr. No.', width: '60px', align: 'center', font: 'font-mono', border: 'border-r border-slate-300', identityType: 'srNo' },
      { id: 'h2', text: 'Exam Seat No.', width: '110px', align: 'center', font: 'font-mono font-bold', border: 'border-r border-slate-300', identityType: 'seatNo' },
