...
public class EdunixoMLPlugin extends Plugin {
    ...
    public void requestMicrophonePermission(PluginCall call) {
        ...
        requestPermissionForAlias("microphone", call, "microphonePermissionRequestCallback");
    }

    @PermissionCallback
    private void microphonePermissionRequestCallback(PluginCall call) {
        JSObject out = new JSObject();
        out.put("granted", getPermissionState("microphone") == PermissionState.GRANTED);
        call.resolve(out);
    }
