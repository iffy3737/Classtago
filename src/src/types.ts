...
export type UserRole = 'super_admin' | 'headmaster' | 'clerk' | 'teacher' | 'class_teacher' | 'student' | 'parent' | 'peon';
...
export interface SubjectGroup {
  id: string;
  groupName: string; // e.g., "Languages", "History + Civics"
  subjectIds: string[];
  groupCode?: string;
  // R2.5.92: Combined Question Paper groups are explicitly tagged.
  // General curriculum groups must not automatically appear in the Teacher Question Paper flow.
  combinedPaperEnabled?: boolean;
}
