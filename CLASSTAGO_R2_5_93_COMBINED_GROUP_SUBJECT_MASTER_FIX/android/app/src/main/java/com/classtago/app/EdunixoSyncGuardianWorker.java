...
public class EdunixoSyncGuardianWorker extends Worker {
    ...
    @NonNull @Override public Result doWork() {
        ...
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.O){
            ...
            channel.setDescription("Reminds you when encrypted Classtago offline work is waiting for authenticated sync");
        ...
        NotificationCompat.Builder builder=new NotificationCompat.Builder(context,CHANNEL_ID)
            ...
            .setContentTitle("Classtago Sync Guardian")
            .setContentText(body)
            .setStyle(new NotificationCompat.BigTextStyle().bigText(body+" Open Classtago while online; the normal authenticated sync engine will safely upload it."))
            .setAutoCancel(true).setContentIntent(open).addAction(0,"Open Classtago",open).setPriority(NotificationCompat.PRIORITY_DEFAULT);
