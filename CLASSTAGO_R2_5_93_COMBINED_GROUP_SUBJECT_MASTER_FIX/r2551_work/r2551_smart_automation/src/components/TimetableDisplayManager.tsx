...
export default function TimetableDisplayManager({ lang, user, onTimetableChange }: TimetableDisplayManagerProps) {
  ...
  const [filterAcademicYear, setFilterAcademicYear] = useState('2026-27');
  ...
  const handleExportExcel = () => {
    ...
    if (viewMode === 'teacher') {
      ...
      // Master
      csvContent += "National High School Taloda - School Master Timetable\n";
    ...
    XLSX.writeFile(workbook, `EDUNIXO_Timetable_${viewMode}_${Date.now()}.xlsx`);
  ...
  return (
    <div className={`space-y-6 ${isFullScreen ? 'fixed inset-0 z-50 bg-slate-50 overflow-auto p-8' : ''}`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="2025-26">2025-26 (Past)</option>
              <option value="2027-28">2027-28 (Next Year)</option>
            </select>
          </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between text-[10px] text-slate-400">
        <span>© 2026 National High School Taloda. Powered by AI Timetable Management.</span>
      ...
      <div id="timetable-display-print-area" className="smart-print-source print-area-wrapper hidden absolute top-0 left-0 w-full bg-white text-black p-8 space-y-6 text-xs text-left">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500 font-bold uppercase mt-0.5">
                Taloda, Nandurbar, Maharashtra, India | UDISE Code: 27210908804
              </p>
              <p className="text-[9px] text-slate-400 mt-0.5">
                Managed by Taloda Education Trust
              </p>
            </div>
          </div>
        ...
        <div className="border-t border-slate-200 pt-3.5 flex justify-between text-[8px] text-slate-400">
          <span>National High School, Taloda - ERP Official Generated Document</span>
