      ...
      <section className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4 sm:p-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-emerald-800">This application is not sent to any EDUNIXO approval queue. Prepare it here, print/save as PDF, and submit it personally to the Chairman of {COMMITTEE_NAME}.</p>
          </div>
        </div>
      </section>
