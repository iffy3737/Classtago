...
const en: PublicPortalCopy = {
  ...
  verifiedInstitution: 'Verified EDUNIXO institution', officialSchoolWebsite: 'Official School Website', welcomeTo: 'Welcome to', studentStaffLogin: 'Student & Staff Login',
  ...
  secureSchoolPortal: 'Secure school portal', poweredBy: 'Powered by EDUNIXO ERP', platform: 'EDUNIXO Platform', websiteLanguage: 'Website language'
};
