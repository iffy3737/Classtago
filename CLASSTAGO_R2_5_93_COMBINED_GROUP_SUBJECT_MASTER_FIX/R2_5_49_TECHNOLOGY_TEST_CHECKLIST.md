# Classtago R2.5.49 Smart Technology Test Checklist
...
3. Smart Tools → **ML Kit Auto Scan & PDF**: scan multipage document, crop/adjust, save PDF; verify Downloads/Classtago.
...
4. Enable native push, create one Classtago notification for that user, verify background notification delivery and deduplication.
