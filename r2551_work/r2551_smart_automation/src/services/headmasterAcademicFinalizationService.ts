...
export type ResultWorkflowSnapshot = {
  ...
  missingMarkScopes: any[]; teacherProgress: any[]; compilationScopes: any[]; validationIssues: any[]; compilationHistory: any[];
  generatedAt?: string;
  summary: {
    subjectLists: Record<string, number>;
    resultBooks: Record<string, number>;
    progressBatches: Record<string, number>;
    operationalExpectedScopes?: number;
    missingMarkScopes?: number;
