  ...
  return (
    ...
    >
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#050816]/80 backdrop-blur-2xl">
        ...
        {mobileMenuOpen && (
          <div className="border-t border-white/10 bg-[#070b1c] px-5 py-4 sm:hidden">
              ...
              <div className="grid items-end gap-8 lg:grid-cols-[1fr_340px]">
                <div className="max-w-4xl">
                  <div className="mb-6 flex items-center gap-4">
                    ...
                    <div><p className="text-[10px] font-black uppercase tracking-[0.24em] text-[var(--school-accent)]">{ui.welcomeTo}</p><p className="mt-1 text-sm font-black text-white sm:text-base">{school.schoolName}</p></div>
                  </div>
      ...
      <footer className="relative z-10 border-t border-white/10 bg-[#03050d]">
