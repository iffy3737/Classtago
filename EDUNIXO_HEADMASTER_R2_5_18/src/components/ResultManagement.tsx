    ...
    <div className={`space-y-6 ${isUrdu ? 'rtl text-right' : 'ltr text-left'}`} id="result-management-module">
      ...
      {isClerk && (
        <div className="space-y-6 animate-fade-in" id="clerk-result-focused-page">
          ...
          <div className="bg-[radial-gradient(circle_at_12%_10%,rgba(16,185,129,.2),transparent_34%),linear-gradient(135deg,#0f172a,#111827_62%,#052e2b)] rounded-2xl p-6 text-white flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border border-emerald-400/15 shadow-xl">
            <div className="space-y-1 text-left">
