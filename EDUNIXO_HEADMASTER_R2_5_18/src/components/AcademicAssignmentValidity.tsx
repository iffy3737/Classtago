...
export default function AcademicAssignmentValidity() {
  ...
  return (
    <div className="space-y-5 text-left">
      <section className="relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-[radial-gradient(circle_at_12%_10%,rgba(34,211,238,.18),transparent_32%),radial-gradient(circle_at_92%_8%,rgba(139,92,246,.22),transparent_35%),linear-gradient(135deg,#07182f,#080b1d_58%,#17122f)] p-5 text-white shadow-[0_28px_80px_rgba(2,6,23,.28)] sm:p-7">
