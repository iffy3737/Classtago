...
/** Dedicated browser ERP flag. app.edunixo.com also activates this automatically. */
export const IS_EDUNIXO_WEB_APP = envFlag('VITE_EDUNIXO_APP_RUNTIME') || browserRequestsAppRuntime();
