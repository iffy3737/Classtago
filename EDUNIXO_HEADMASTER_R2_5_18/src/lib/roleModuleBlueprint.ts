...
export const ROLE_MODULE_BLUEPRINT: Record<string, RoleModuleCategory[]> = {
  "headmaster": [
...

        {
          ...
          "features": [
            ...
            },
            {
              ...
              "label": "Admission campaign publication → Admission Campaigns",
              "targetTab": "website_studio",
              "shortcut": true,
              "ownerModuleId": "hm-admission-campaigns",
              "ownerFeatureId": "campaign-workspace"
            },
            {
    ...
    {
      "id": "website-design-main",
      "label": "Website Design",
      "standalone": true,
      "modules": [
        {
          "id": "hm-website-studio",
          "label": "Website Design",
          "tab": "website_studio",
          "description": "Six real website pages. Save and publish controls appear at the bottom of every page, not as menu entries.",
          "features": [
            {
              "id": "school-identity-hero",
              "label": "Identity & Hero"
            },
            {
              "id": "media-gallery",
            ...
            {
              "id": "public-page-content",
              "label": "Page Content"
            },
            {
              "id": "contact-social-seo",
              "label": "Contact & SEO"
            },
            {
    ...
    {
      "id": "admission-campaigns-main",
      "label": "Admission Campaigns",
      "standalone": true,
      "modules": [
        {
          ...
          "label": "Admission Campaigns",
          "tab": "website_studio",
          "description": "Campaign setup, submitted applications and final admission confirmation are three real pages inside one admission module.",
          "features": [
            {
    ...
    },
    {
      ...
      "modules": [
        ...
        },
        {
          ...
          "description": "Subject marks entry only for the Headmaster's own assigned teaching subjects.",
          "features": []
        },
        {
          "id": "tr-my-timetable",
    ...
    },
    {
      ...
      "modules": [
        ...
        },
        {
          ...
          "tab": "result_management",
          "description": "The complete working result workspace for Headmaster review, monitoring and result workflow oversight.",
          "features": [
            {
              "id": "result-overview",
  ...
  "clerk": [
    ...
    },
    {
      ...
      "modules": [
        ...
        {
          "id": "cl-admission-applications",
          "label": "Admission Applications",
          "tab": "website_studio",
          "description": "Review public/walk-in applications, verify documents and recommend a decision. Final approval remains Headmaster-only.",
          "features": [
            { "id": "cl-application-queue", "label": "Application review queue" },
            { "id": "cl-full-application", "label": "Complete application viewer" },
            { "id": "cl-document-check", "label": "Document verification" },
            { "id": "cl-application-notes", "label": "Review notes & corrections" }
          ]
        },
        {
          "id": "cl-admission-processing",
          "label": "Admission Preparation & Handoff",
          "tab": "website_studio",
          "description": "Prepare GR/class details and mark the application Verified / Recommended for Headmaster final confirmation.",
          "features": [
            { "id": "cl-prepare-admission", "label": "Prepare admission confirmation" },
            { "id": "cl-student-record-draft", "label": "Prepare Student Master draft" },
            { "id": "cl-gr-sequence-prep", "label": "Prepare GR / admission number" },
            { "id": "cl-headmaster-confirmation", "label": "Verify & send to Headmaster" }
          ]
        }
      ]
    },
      ...
      "modules": [
        {
          ...
          "tab": "result_management",
          "description": "Maintain official Master Mark List and Master Progress Card template structures, print accepted result outputs, and maintain the Master Result Book. Teacher template routing is automatic from Academic Assignments; Clerk does not manually map teachers/classes/subjects to templates and cannot publish/finalize results.",
          "features": [
      ...
      "modules": [
        {
          ...
          "label": "Website Draft Content",
          "tab": "website_studio",
          "description": "Delegated website content/media drafting and preview only. Publish remains Headmaster-only.",
          "features": [
    ...
    },
    {
      ...
      "modules": [
        ...
        },
        {
          ...
          "tab": "master_data",
          "description": "Focused delegated office masters only; Student, Staff, Subject, Result and Certificate canonical owners are not duplicated here.",
          "features": [
