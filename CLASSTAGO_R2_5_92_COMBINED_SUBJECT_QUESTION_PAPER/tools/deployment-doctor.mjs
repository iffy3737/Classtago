...
if (problems.length) {
  console.error(`[Classtago] Deployment doctor failed:\n - ${problems.join('\n - ')}`);
  process.exit(1);
}
console.log('[Classtago] Deployment doctor: OK');
console.log(`[Classtago] Version: ${pkg.version}`);
console.log('[Classtago] Repository root is clean; no legacy full-project copies detected.');
console.log('[Classtago] Render Blueprint and native Android project are present.');
