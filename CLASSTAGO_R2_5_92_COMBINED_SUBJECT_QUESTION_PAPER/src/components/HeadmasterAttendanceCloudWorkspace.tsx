...
export default function HeadmasterAttendanceCloudWorkspace({ user, activeFeatureId = 'attendance-dashboard' }: Props) {
  ...
  const SubjectAttendance = () => <div className="space-y-5">
    <Header title="Subject-wise Attendance" subtitle="Classtago does not invent period/subject attendance from daily P/A records. This page shows the canonical readiness state until a separate subject-attendance capture source is installed." icon={<FileText className="h-5 w-5"/>}/>
    <Alerts/>
