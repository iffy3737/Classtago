                    ...
                    {paymentMode === 'QR Code' && (
                      <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3">
                        ...
                        <div className="text-xs text-amber-900 space-y-1">
                          ...
                          <p>EDUNIXO will not generate a placeholder UPI address. Accept payment only through the school's verified banking/UPI setup and record the real transaction reference below.</p>
            ...
            <div className="bg-slate-100 border border-slate-300 rounded-2xl p-6 overflow-x-auto relative text-left">
              ...
              <div id="print-area" className={`bg-white p-10 shadow-lg mx-auto text-slate-900 text-xs font-sans relative border border-slate-300 ${
                ...
                <p className="text-center text-[10px] text-slate-500 italic mt-6">
                  * Receipt recorded in EDUNIXO. Bank/UPI/Cash reconciliation remains subject to the school's official accounting records. *
                </p>
